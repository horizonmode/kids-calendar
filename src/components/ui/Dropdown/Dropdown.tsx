...
export const DropdownCategoryTitle = ({
  ...
  return (
    <div className="text-[.65rem] font-semibold mb-1 uppercase text-white px-1.5">
      {children}
    </div>
  );
};
...
>(function DropdownButtonInner(
  ...
  const buttonClass = cn(
    "flex items-center gap-2 p-1.5 text-md font-medium text-neutral-500 dark:text-neutral-400 text-left bg-transparent w-full rounded",
    !isActive && !disabled,
